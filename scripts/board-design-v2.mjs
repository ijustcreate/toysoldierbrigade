...
function canvas(source, urls, dark = true, page = 0) {
  ...
  return {
    ...
    donorIds: [], active: false, panels: [], fontFamily: "DM Sans", nameSize: 18,
    donorScrollEnabled: false, showIcons: false, showSubtext: false,
    backgroundMode: "image", backgroundImage: dark ? source.orientation === "Portrait" ? urls.celebration : urls.navy : urls.ivory,
